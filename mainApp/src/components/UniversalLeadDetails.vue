<template>
  <div class="universal-lead-details">
    <div class="js-leftcolumn js-scrollbar leftcolumn-wrapper skinny-scrollbar skinny-scrollbar--y">
      <div class="leftcolumn">
        <div id="detail-close" class="panel-close">
        ...
        <div class="leftcol-top js-leftcol-top pb10">
          <div>
            <div class="leftcolumn-profilepic" style="padding-top: 20px;margin-bottom: -20px;">
              <div class="leftcolumn-sendlinks" style="top:8px;"></div>

              <div class="leftcolumn-sendlinks" style="top:40px;">
                <div
                  class="leftColumn-sendlink js-forceshow-prolinc-dropdown"
              ...
              <div class="leftcolumn-communicationicons">
                <a
                  ...
                  class="leftcolumn-communicationicon pointer js-call"
                >
                  <span
                    class="js-Left-tooltip"
                    data-toggle="tooltip"
                    data-placement="bottom"
                    :title="'Call ' + selectedLead.firstName"
                  >
                ...
                <div class="leftcolumn-communicationicon pointer js-send-text">
                  <span
                    ...
                    data-toggle="tooltip"
                    data-placement="bottom"
                    :title="'Text ' + selectedLead.firstName"
                  >
                ...
                <div class="leftcolumn-communicationicon pointer js-email-address">
                  <span
                    ...
                    data-toggle="tooltip"
                    data-placement="bottom"
                    :title="'Email ' + selectedLead.firstName"
                  >
                ...
                <div class="pb5">
                  ...
                  <div class="btn-group">
                    <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                      <span class style="color:#018aab;">{{computedPhoneNumber}}</span>
            ...
            <div class="minigrid minigrid-thirds pt5" style="display:flex">
              <div class="lead-type-check" style="flex: 0 33.333%">
                <div class="checkbox custom-checkbox" title="Buyer Lead">
                  <input
                    type="checkbox"
                    id="lead-details-cb-buyer-lead"
                    class="js-lead-type"
                    name="buyerLead"
                    value="1"
                    data-target="div"
                    data-contextual="stroke"
                    :checked="selectedLead.leadType === 'Buyer'"
                  />
              ...
              <div class="lead-type-check" style="flex: 0 33.333%">
                <div class="checkbox custom-checkbox" title="Seller Lead">
                  <input
                    type="checkbox"
                    id="lead-details-cb-seller-lead"
                    class="js-lead-type"
                    name="sellerLead"
                    value="1"
                    data-target="div"
                    data-contextual="stroke"
                    :checked="selectedLead.leadType === 'Seller'"
                  />
              ...
              <div class="lead-type-check" style="flex: 0 33.333%">
                <div class="checkbox custom-checkbox" title="Partial Lead">
                  <input
                    type="checkbox"
                    id="lead-details-cb-partial-lead"
                    class="js-lead-type"
                    name="incompleteLead"
                    value="1"
                    data-target="div"
                    data-contextual="stroke"
                    :checked="selectedLead.leadType === 'Partial'"
                  />
...
export default class UniversalLeadDetails extends Vue {
  ...
  get computedEmail() {
    return (
      this.$store.state.lead.selectedLead.firstName +
      '.' +
      this.$store.state.lead.selectedLead.lastName +
      '@gmail.com'
    );
  }
}
